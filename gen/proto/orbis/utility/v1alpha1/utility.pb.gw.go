...
func request_UtilityService_ACPCreatePolicy_0(ctx context.Context, marshaler runtime.Marshaler, client UtilityServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ACPCreatePolicyRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ACPCreatePolicy(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_UtilityService_ACPCreatePolicy_0(ctx context.Context, marshaler runtime.Marshaler, server UtilityServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ACPCreatePolicyRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ACPCreatePolicy(ctx, &protoReq)
	return msg, metadata, err

}

func request_UtilityService_ACPRegisterObject_0(ctx context.Context, marshaler runtime.Marshaler, client UtilityServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ACPRegisterObjectRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ACPRegisterObject(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_UtilityService_ACPRegisterObject_0(ctx context.Context, marshaler runtime.Marshaler, server UtilityServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ACPRegisterObjectRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ACPRegisterObject(ctx, &protoReq)
	return msg, metadata, err

}

func request_UtilityService_ACPSetRelationship_0(ctx context.Context, marshaler runtime.Marshaler, client UtilityServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ACPSetRelationshipRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ACPSetRelationship(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_UtilityService_ACPSetRelationship_0(ctx context.Context, marshaler runtime.Marshaler, server UtilityServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ACPSetRelationshipRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ACPSetRelationship(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterUtilityServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UtilityServiceServer) error {
	...
	mux.Handle("POST", pattern_UtilityService_ACPCreatePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/orbis.utility.v1alpha1.UtilityService/ACPCreatePolicy", runtime.WithHTTPPathPattern("/v1alpha1/utility/acp:createpolicy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_UtilityService_ACPCreatePolicy_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_UtilityService_ACPCreatePolicy_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_UtilityService_ACPRegisterObject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/orbis.utility.v1alpha1.UtilityService/ACPRegisterObject", runtime.WithHTTPPathPattern("/v1alpha1/utility/acp:registerobject"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_UtilityService_ACPRegisterObject_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_UtilityService_ACPRegisterObject_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_UtilityService_ACPSetRelationship_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/orbis.utility.v1alpha1.UtilityService/ACPSetRelationship", runtime.WithHTTPPathPattern("/v1alpha1/utility/acp:setrelationship"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_UtilityService_ACPSetRelationship_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_UtilityService_ACPSetRelationship_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterUtilityServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UtilityServiceClient) error {
	...
	mux.Handle("POST", pattern_UtilityService_ACPCreatePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/orbis.utility.v1alpha1.UtilityService/ACPCreatePolicy", runtime.WithHTTPPathPattern("/v1alpha1/utility/acp:createpolicy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_UtilityService_ACPCreatePolicy_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_UtilityService_ACPRegisterObject_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/orbis.utility.v1alpha1.UtilityService/ACPRegisterObject", runtime.WithHTTPPathPattern("/v1alpha1/utility/acp:registerobject"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_UtilityService_ACPRegisterObject_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_UtilityService_ACPSetRelationship_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/orbis.utility.v1alpha1.UtilityService/ACPSetRelationship", runtime.WithHTTPPathPattern("/v1alpha1/utility/acp:setrelationship"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_UtilityService_ACPSetRelationship_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_UtilityService_ACPCreatePolicy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1alpha1", "utility", "acp"}, "createpolicy"))

	pattern_UtilityService_ACPRegisterObject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1alpha1", "utility", "acp"}, "registerobject"))

	pattern_UtilityService_ACPSetRelationship_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1alpha1", "utility", "acp"}, "setrelationship"))
)
...
var (
	...
	forward_UtilityService_ACPCreatePolicy_0 = runtime.ForwardResponseMessage

	forward_UtilityService_ACPRegisterObject_0 = runtime.ForwardResponseMessage

	forward_UtilityService_ACPSetRelationship_0 = runtime.ForwardResponseMessage
)
